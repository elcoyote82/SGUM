...
class ProveedoresMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.ProveedoresMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('proveedores');
		$tMap->setPhpName('Proveedores');

		$tMap->setUseIdGenerator(true);

		$tMap->addPrimaryKey('ID_PROVEEDOR', 'IdProveedor', 'int', CreoleTypes::INTEGER, true, null);

		$tMap->addColumn('ID_MD5_PROVEEDOR', 'IdMd5Proveedor', 'string', CreoleTypes::VARCHAR, true, 255);
		...
		$tMap->addColumn('DIRECCION', 'Direccion', 'string', CreoleTypes::VARCHAR, true, 255);
