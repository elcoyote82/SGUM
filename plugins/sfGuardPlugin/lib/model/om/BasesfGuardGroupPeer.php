...
abstract class BasesfGuardGroupPeer {
	...
	const ID_MD5 = 'sf_guard_group.ID_MD5';

	
	const UPDATED_AT = 'sf_guard_group.UPDATED_AT';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (sfGuardGroupPeer::ID, sfGuardGroupPeer::NAME, sfGuardGroupPeer::DESCRIPTION, sfGuardGroupPeer::ID_MD5, sfGuardGroupPeer::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (sfGuardGroupPeer::ID => 0, sfGuardGroupPeer::NAME => 1, sfGuardGroupPeer::DESCRIPTION => 2, sfGuardGroupPeer::ID_MD5 => 3, sfGuardGroupPeer::UPDATED_AT => 4, ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardGroupPeer::ID_MD5);

		$criteria->addSelectColumn(sfGuardGroupPeer::UPDATED_AT);
