...
abstract class BasesfGuardPermissionPeer {
	...
	const ID_MD5 = 'sf_guard_permission.ID_MD5';

	
	const UPDATED_AT = 'sf_guard_permission.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Description', 'IdMd5', 'UpdatedAt', ),
		BasePeer::TYPE_COLNAME => array (sfGuardPermissionPeer::ID, sfGuardPermissionPeer::NAME, sfGuardPermissionPeer::DESCRIPTION, sfGuardPermissionPeer::ID_MD5, sfGuardPermissionPeer::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'description', 'id_md5', 'updated_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Description' => 2, 'IdMd5' => 3, 'UpdatedAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (sfGuardPermissionPeer::ID => 0, sfGuardPermissionPeer::NAME => 1, sfGuardPermissionPeer::DESCRIPTION => 2, sfGuardPermissionPeer::ID_MD5 => 3, sfGuardPermissionPeer::UPDATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'id_md5' => 3, 'updated_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardPermissionPeer::ID_MD5);

		$criteria->addSelectColumn(sfGuardPermissionPeer::UPDATED_AT);
