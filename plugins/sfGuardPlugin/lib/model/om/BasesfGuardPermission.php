...
abstract class BasesfGuardPermission extends BaseObject  implements Persistent {
	...
	public function setIdMd5($v)
	{
		...
		if ($this->id_md5 !== $v) {
			$this->id_md5 = $v;
			$this->modifiedColumns[] = sfGuardPermissionPeer::ID_MD5;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = sfGuardPermissionPeer::UPDATED_AT;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->id_md5 = $rs->getString($startcol + 3);
	...
	{
    if ($this->isModified() && !$this->isColumnModified(sfGuardPermissionPeer::UPDATED_AT))
    {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setIdMd5($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardPermissionPeer::ID_MD5)) $criteria->add(sfGuardPermissionPeer::ID_MD5, $this->id_md5);
		if ($this->isColumnModified(sfGuardPermissionPeer::UPDATED_AT)) $criteria->add(sfGuardPermissionPeer::UPDATED_AT, $this->updated_at);
