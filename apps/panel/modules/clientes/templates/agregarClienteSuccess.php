...
<div id="tituloTabla" >
	<?php echo __("AGREGANDO CLIENTE"); ?>
</div>
<?php if(!isset($msg)): ?>
	<?php echo form_tag('/clientes/agregarCliente'); ?>    
	<table class='centrarTablas'>
        <thead>
          <tr>
            <td colspan='2'><?php echo __("Agregar Cliente"); ?></td>
          </tr>
        </thead>
        <tr>
...
<?php else: ?>
	<table class='centrarTablas'>
		...
		<tr>
			<td><?php echo button_to('Agregar Otro','/clientes/agregarCliente',array('class' => 'buttonEsqueleto2')); ?></td>
			<td><?php echo button_to('Volver','clientes/index',array('class' => 'buttonEsqueleto2')); ?></td></tr>
	</table>
<?php endif; ?>