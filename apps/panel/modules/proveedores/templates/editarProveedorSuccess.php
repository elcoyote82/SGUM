...
<div id="tituloTabla" >
	<?php echo __("EDITANDO PROVEEDOR"); ?>
</div>
<?php if(!isset($msg)): ?>
	<?php echo form_tag('/proveedores/editarProveedor'); ?>	
	<?php echo input_hidden_tag('id_md5_proveedor',$id_md5_proveedor); ?>     
	<table class='centrarTablas'>
        <thead>
          <tr>
            <td colspan='2'><?php echo __("Editar Proveedor"); ?></td>
          </tr>
        </thead>
        <tr>
			...
			<td>
				...
				<?php echo input_tag('nombre',$obj_proveedor->getNombre(),'size=50x10'); ?>
			</td>
		</tr>
        <tr>
			...
			<td>
				...
				<?php if($sf_request->hasError('cif_nif')): ?>
					...
					<?php endif; ?>
				<?php endif; ?>
				<?php echo input_tag('cif_nif',$obj_proveedor->getCifNif(),'size=50x10'); ?>
			</td>
		</tr>
        <tr>
			...
			<td>
				...
				<?php echo input_tag('direccion',$obj_proveedor->getDireccion(),'size=50x10'); ?>
			</td>
		</tr>
        <tr>
			...
			<td>
				...
				<?php echo input_tag('poblacion',$obj_proveedor->getPoblacion(),'size=50x10'); ?>
			</td>
		</tr>
        <tr>
			...
			<td>
				...
				<?php echo select_tag('provincia',options_for_select($ar_provincias,$obj_proveedor->getProvincia())); ?>
			</td>
		</tr>
        <tr>
			...
			<td>
				...
				<?php echo input_tag('cp',$obj_proveedor->getCp(),'size=50x10'); ?>
			</td>
		</tr>
        <tr>
			...
			<td>
				...
				<?php echo select_country_tag('pais',$obj_proveedor->getPais()); ?>
			</td>
		</tr>
		<tr>
			<td align="left">
		...
		<?php endif; ?>
			...
			<td>
				...
				<?php else: ?>
					<?php echo input_tag('telefono2',$obj_proveedor->getTelefono2()); ?>
				<?php endif; ?>				
			</td>
		</tr>
        <tr>
			...
			<td>
				...
				<?php echo input_tag('movil',$obj_proveedor->getMovil(),'size=50x10'); ?>
			</td>
		</tr>	
        <tr>
			...
			<td>
				...
				<?php echo input_tag('fax',$obj_proveedor->getFax(),'size=50x10'); ?>
			</td>
		</tr>	
        <tr>
			...
			<td>
				...
				<?php echo input_tag('email',$obj_proveedor->getEmail(),'size=50x10'); ?>
			</td>
		</tr>	
        <tr>
			...
			<td>
				...
				<?php echo input_tag('web',$obj_proveedor->getWeb(),'size=50x10'); ?>
			</td>
		</tr>		
		<tr>
			<td>
				<?php echo button_to(__('Cancelar'),'proveedores/index',array('class'  => 'buttonEsqueleto2')) ?>
			</td>
			<td>
...
<?php else: ?>
	<table class='centrarTablas'>
		...
		<tr>
			<td><?php echo button_to('Volver','proveedores/index',array('class' => 'buttonEsqueleto2')); ?></td>
		</tr>
	</table>
<?php endif; ?>