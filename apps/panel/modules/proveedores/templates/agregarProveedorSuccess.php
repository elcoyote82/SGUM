...
<div id="tituloTabla" >
	<?php echo __("AGREGANDO PROVEEDOR"); ?>
</div>
<?php if(!isset($msg)): ?>
	<?php echo form_tag('/proveedores/agregarProveedor'); ?>    
	<table class='centrarTablas'>
        <thead>
          <tr>
            <td colspan='2'><?php echo __("Agregar Proveedor"); ?></td>
          </tr>
        </thead>
        <tr>
...
<?php else: ?>
	<table class='centrarTablas'>
		...
		<tr>
			<td><?php echo button_to('Agregar Otro','/proveedores/agregarProveedor',array('class' => 'buttonEsqueleto2')); ?></td>
			<td><?php echo button_to('Volver','proveedores/index',array('class' => 'buttonEsqueleto2')); ?></td></tr>
	</table>
<?php endif; ?>