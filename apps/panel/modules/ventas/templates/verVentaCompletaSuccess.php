...
<div id="tituloPedido" >
	<?php echo __("Venta '").$obj_venta->getNumVenta()."' | ".$acc_fechas->cambiarFormatoFecha14($obj_venta->getUpdatedAt())." | ".__("Salida '").$obj_salida->getNumSalida()."' | ".$acc_fechas->cambiarFormatoFecha14($obj_salida->getUpdatedAt()); ?>
</div>
<div id='ficha'>
	<div id="sidebar-tabs">
		<div id="mostPopWidget">
        	<div id="tabsContainer">
        		<ul class="tabs">
        			...
        			<li><a href='#'><?php echo __("<strong>Datos Salida</strong>"); ?></a></li>
					...
					<div class='ficha_venta_articulos'>
						<table class='tabla_ficha'>
							...
							<?php if(empty($ar_lineas_salida)):?>
								<td colspan='5' align="center"><?php echo __("Todavía no han procesado la salida de mercancias para la venta."); ?></td></tr>
							<?php else: ?>
        			...
        			<div class='ficha_informe_ventas'>
        				<?php if(!$mostrar_informe_salida):?>
		        			<table class='tabla_ficha'>
								...
								<tr>								
									<td align="center"><?php echo __("No se ha generado todavía ningún informe de salida para la venta."); ?></td>
								</tr>
							</table>
						<?php else: ?>
