...
<div id="tituloPedido" >
	<?php echo __("Pedido '").$obj_pedido->getNumPedido()."' | ".$acc_fechas->cambiarFormatoFecha14($obj_pedido->getUpdatedAt())." | ".__("Entrada '").$obj_entrada->getNumEntrada()."' | ".$acc_fechas->cambiarFormatoFecha14($obj_entrada->getUpdatedAt()); ?>
</div>
<div id='ficha'>
	<div id="sidebar-tabs">
		<div id="mostPopWidget">
        	<div id="tabsContainer">
        		<ul class="tabs">
        			...
        			<li><a href='#'><?php echo __("<strong>Datos Entrada</strong>"); ?></a></li>
