...
<div id="tituloTabla">
  <?php echo __("BORRANDO PERMISOS"); ?>
</div>
<table class='centrarTablas'>
	<thead>
		<tr>
			<td colspan='2'><?php echo __("Borrar Permiso"); ?></td>
		</tr>
	</thead>
	<tr><td><?php echo $msg; ?></td></tr>
	<tr><td colspan='2'><?php echo button_to('Volver','administracion/administrarPermisos',array('class' => 'buttonEsqueleto2')); ?></td></tr>
</table>