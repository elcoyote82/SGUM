...
<div id="tituloTabla" >
	<?php echo __("AGREGANDO ESTADO VENTA"); ?>
</div>
<?php if (!isset($msg)): ?>
	<?php echo form_tag('/administracion/crearEstadoVenta'); ?>
		<table class='centrarTablas'>
			<thead>
				<tr><td align='center' colspan='2'><?php echo __("Agregar Estado Venta"); ?></td></tr>
			</thead>
			<tr>
				<td align='center'><?php echo __("<strong>Estado: </strong>"); ?></td>
				<td>
					<?php echo form_error('estado_venta'); ?>
					<?php echo input_tag('estado_venta'); ?>
				</td>
			</tr>
			<tr>
...
<?php else: ?>
	<table class='centrarTablas'>
		<thead>
			<tr>
				<td colspan='2'><?php echo __("Agregar Estado Venta"); ?></td>
			</tr>
		</thead>
		<tr><td align='center' colspan='2'><?php echo $msg; ?></td></tr>
		<tr>
			<td><?php echo button_to('Agregar Otro','/administracion/crearEstadoVenta',array('class' => 'buttonEsqueleto2')); ?></td>
