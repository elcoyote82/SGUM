...
<div id="tituloTabla" >
	<?php echo __("EDITANDO ESTADO VENTA"); ?>
</div>
<?php if (!isset($msg)): ?>
	<?php echo form_tag('/administracion/editarEstadoVenta'); ?>
		<?php echo input_hidden_tag('id_estado_venta',$id_estado_venta); ?>
		<table class='centrarTablas'>
			<thead>
				<tr><td align='center' colspan='2'><?php echo __("Editar Estado Venta"); ?></td></tr>
			</thead>
			<tr>
				<td align='center'><?php echo __("<strong>Estado: </strong>"); ?></td>
				<td>
					<?php echo form_error('estado_venta'); ?>
					<?php echo input_tag('estado_venta',$obj_estado_venta->getEstadoVenta()); ?>
				</td>
			</tr>
			<tr>
...
<?php else: ?>
	<table class='centrarTablas'>
		<thead>
			<tr>
				<td><?php echo __("Editar Estado Venta"); ?></td>
			</tr>
		</thead>
