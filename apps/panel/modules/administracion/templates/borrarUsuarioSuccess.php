...
<div id="tituloTabla">
  <?php echo __("BORRANDO USUARIOS"); ?>
</div>
<table class='centrarTablas'>
	<thead>
		<tr>
			<td colspan='2'><?php echo __("Borrar Usuario"); ?></td>
		</tr>
	</thead>
	<tr><td><?php echo $msg; ?></td></tr>
	<tr><td colspan='2'><?php echo button_to('Volver','administracion/index',array('class' => 'buttonEsqueleto2')); ?></td></tr>
</table>