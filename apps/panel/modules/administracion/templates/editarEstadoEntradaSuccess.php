...
<div id="tituloTabla" >
	<?php echo __("EDITANDO ESTADO ENTRADA"); ?>
</div>
<?php if (!isset($msg)): ?>
	<?php echo form_tag('/administracion/editarEstadoEntrada'); ?>
		<?php echo input_hidden_tag('id_estado_entrada',$id_estado_entrada); ?>
		<table class='centrarTablas'>
			<thead>
				<tr><td align='center' colspan='2'><?php echo __("Editar Estado Entrada"); ?></td></tr>
			</thead>
			<tr>
				<td align='center'><?php echo __("<strong>Estado: </strong>"); ?></td>
				<td>
					<?php echo form_error('estado_entrada'); ?>
					<?php echo input_tag('estado_entrada',$obj_estado_entrada->getEstadoEntrada()); ?>
				</td>
			</tr>
			<tr>
...
<?php else: ?>
	<table class='centrarTablas'>
		<thead>
			<tr>
				<td><?php echo __("Editar Estado Entrada"); ?></td>
			</tr>
		</thead>
